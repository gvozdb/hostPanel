...
class hostPanelHomeManagerController extends hostPanelMainController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->hostPanel->config['jsUrl'] . 'libs/jquery/jquery.min.js');

        $this->addJavascript($this->hostPanel->config['jsUrl'] . 'mgr/misc/combo.js');
