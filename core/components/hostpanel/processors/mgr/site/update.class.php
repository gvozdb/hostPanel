...
class hostPanelSiteUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (!$this->version = trim($this->getProperty('version'))) {
            return $this->modx->lexicon('hostpanel_site_err_version');
        }
    ...
    public function afterSave()
    {
        ...
        if ($obj->get('cms') != 'modx') {
            ...
            return $this->failure($this->modx->lexicon('hostpanel_site_err_cms_not_supported_update'));
        }
...
return 'hostPanelSiteUpdateProcessor';
