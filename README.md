...
hostPanel is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/hostPanel.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory hostPanel is now in, and do this:
...
Now, you'll want to change references to hostPanel in the files in your
new copied-from-hostPanel repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'hostPanel' to whatever the
name of your component is.

## Copyright Information

hostPanel is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of hostPanel the ability to modify, distribute
and use hostPanel in MODx development as they see fit, as long as attribution
